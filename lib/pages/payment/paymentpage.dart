...
import 'package:gymwebapp/domains/payementrepo/paymentrepo.dart';
...
@RoutePage()
class AtomPaymentPage extends StatefulWidget {
  final mode;
  final payDetails;
  final responsehashKey;
  final responseDecryptionKey;

  const AtomPaymentPage(this.mode, this.payDetails, this.responsehashKey,
...
class _PaymentPageState extends State<AtomPaymentPage> {
  final mode;
  final payDetails;
